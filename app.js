...
위 사업 계획의 기획 근거와 타당성을 입증하기 위해, 구글 Deep Research 기능을 통해 최신 통계와 정책 자료 및 유사 우수사례를 심층적으로 다각도 자동 탐색하여 하나의 완성된 [기획 근거용 딥리서치 보고서]를 빌드해줘.

보고서에는 구체적인 수치 데이터와 함께 공신력 있는 출처(기관명, 공식 보고서명 또는 URL)가 반드시 포함되어야 하며, 다음 3가지 핵심 영역이 정밀하게 기술되어야 해:

1. [대상 지역의 실태 통계]: ${region} 내 ${state.currentTopic} 관련 아동/취약계층의 구체적인 결핍 실태, 대상 인구 수, 혹은 복지 사각지대 지표
2. [정부/지자체 정책 근거]: 보건복지부, 교육부 또는 해당 지자체(광주광역시 등)에서 추진하고 있는 이 사업 주제 관련 최근 정책 아젠다 및 조례적 지원 근거
...
1. [대상 지역의 실태 통계]: ${regionSpan} 내 ${topicSpan} 관련 아동/취약계층의 구체적인 결핍 실태, 대상 인구 수, 혹은 복지 사각지대 지표
2. [정부/지자체 정책 근거]: 보건복지부, 교육부 또는 해당 지자체(광주광역시 등)에서 추진하고 있는 이 사업 주제 관련 최근 정책 아젠다 및 조례적 지원 근거
3. [검증된 우수 프로그램 선례]: 타 기관에서 수행하여 효과성이 객관적으로 입증된 유사 사업 명칭과 당시 활용된 구체적인 성과 평가 척도 도구`;
